                      ...
                      std::vector<cv::DMatch> &matches, std::string descriptorType, std::string matcherType, std::string selectorType)
{
    ...
    if (matcherType.compare("MAT_BF") == 0)
    {
        ...
        {
            // Not supported specified descriptorType
    ...
    {
        // Not supported specified matcherType
...
{
    // Detector parameters
    int blockSize = 2;     // for every pixel, a blockSize ÃÂ blockSize neighborhood is considered
...
void detKeypointsModern(std::vector<cv::KeyPoint> &keypoints, cv::Mat &img, std::string detectorType, bool bVis)
{
    ...
    if (detectorType.compare("FAST") == 0)
    {
        ...
        windowName = "FAST Detection Results";
    }
    else if (detectorType.compare("BRISK") == 0)
    {
        ...
        windowName = "BRISK Detection Results";
    }
    else if (detectorType.compare("ORB") == 0)
    {
        ...
        windowName = "ORB Detection Results";
    }
    else if (detectorType.compare("AKAZE") == 0)
    {
        ...
        windowName = "AKAZE Detection Results";
    }
    else if (detectorType.compare("SIFT") == 0)
    {
        ...
        windowName = "SIFT Detection Results";
    }
    else
    {
        // Not supported specified detectorType
